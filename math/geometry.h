#pragma once
#include "global/global_operators.h"
...
struct geometry_path
{
	...
	void push_elliptic_arc(vector<float32, 2> point, float32 rx, float32 ry, float32 begin_angle, float32 end_angle, float32 rotation);
